                        ...
                        <form action="{{ route("admin.customers.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group {{ $errors->has('mobile_number') ? 'has-error' : '' }}">
                                    <label
                                        for="mobile_number">{{ trans('global.customer.fields.mobile_number') }}</label>
                                    <input type="tel" id="mobile_number" maxlength="10" name="mobile_number"
                                           class="form-control"
                                           value="{{ old('mobile_number', isset($customer) ? $customer->mobile_number : '') }}">
                                ...
                                <div class="col-md-6 form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="password" name="password" class="form-control"
                                           value="{{ old('password', isset($customer) ? $customer->password : '') }}">
                                ...
                                <div class="col-md-6 form-group {{ $errors->has('pincode') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="number" minlength="6" maxlength="10" name="pincode"
                                           class="form-control"
                                           value="{{ old('pincode', isset($customer) ? $customer->pincode : '') }}">
